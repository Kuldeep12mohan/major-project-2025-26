      ...
      <header className="bg-gradient-to-r from-red-900 via-red-800 to-red-900 text-white py-6 px-8 shadow-xl">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-3xl font-bold tracking-tight">Course Registration Portal</h1>
          </div>
      ...
      <main className="flex-grow flex flex-col justify-center items-center text-center p-8">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed">
            A sophisticated platform designed to streamline course registration for students 
            and empower teachers with comprehensive course management tools and real-time enrollment insights.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12 max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
              ...
              <p className="text-gray-600 text-sm">Browse courses, manage registrations, and track your academic journey with ease.</p>
            </div>
            
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
              <div className="w-12 h-12 bg-red-100 rounded-xl flex items-center justify-center mb-4 mx-auto">
                <svg className="w-6 h-6 text-red-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-6m-2 0H5m2 0v-5a2 2 0 012-2h2a2 2 0 012 2v5m6 0v-3a2 2 0 00-2-2h-2a2 2 0 00-2 2v3" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-gray-800 mb-2">For Teachers</h3>
              <p className="text-gray-600 text-sm">Create courses, monitor enrollments, and manage your teaching portfolio effectively.</p>
            </div>
          </div>
